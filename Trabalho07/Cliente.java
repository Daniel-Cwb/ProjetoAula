...
public class Cliente extends Thread{
	...
	public void run() {
		...
		System.out.println("\n");
		System.out.println("CPF: " + this.cpf + " Ano de Nascimento: " + this.anoNascimento + " Nome: " + this.nome + " E-mail: " + this.email);
		System.out.println("Conta " + this.conta.getNumero() + " Saldo: " + this.conta.getSaldo());
